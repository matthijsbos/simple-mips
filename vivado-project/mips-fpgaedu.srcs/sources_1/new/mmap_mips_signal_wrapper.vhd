...
entity mmap_mips_signal_wrapper is
    port (
        clk                     : in std_logic;
        ...
        mips_sig_reg_wr_i       : in std_logic;
...
end mmap_mips_signal_wrapper;

architecture Behavioral of mmap_mips_signal_wrapper is
    ...
    begin
        ...
        if rising_edge(clk) then
            case to_integer(unsigned(addr)) is
                ...
                when 18 => 
                    dout <= (0 => mips_sig_reg_wr_i, others => '0');
                when others =>
                    dout <= (others => '0');
            end case;
        end if;
